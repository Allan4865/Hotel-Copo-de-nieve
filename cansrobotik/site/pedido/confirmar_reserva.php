...
if (isset($_GET['nombre']) && isset($_GET['descripcion']) && isset($_GET['precio']) && isset($_GET['id_kit']) && isset($_GET['cantidad'])) {
    $nombreKit = $_GET['nombre'];
    $descripcionKit = $_GET['descripcion'];
    $precioKit = $_GET['precio'];
    $id_kit = $_GET['id_kit'];
    $cantidadKit = $_GET['cantidad'];
...
<body>
    <div class="container">
        ...
        <p><strong>Nombre del Kit:</strong> <?php echo $nombreKit; ?></p>
        <p><strong>Descripcion</strong> <?php echo $descripcionKit; ?></p>
        <p><strong>Precio Total:</strong> <?php echo $precioKit; ?></p>
