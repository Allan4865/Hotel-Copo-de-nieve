...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'adrianmolina410@gmail.com'; // Cambia esto con tu dirección de correo
    $mail->Password   = 'lcai uetq vqoo igks'; // Cambia esto con tu contraseña
    ...
    $mail->setFrom('adrianmolina410@gmail.com', 'HOTEL COPO DE NIVE');
