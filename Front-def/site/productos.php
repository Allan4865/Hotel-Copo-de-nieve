...
<html class="wide wow-animation" lang="en">
  ...
  <div class="shell">
    ...
    <div class="range range-30" id="productos-container" data-lightgallery="group">
      ...
      $sql = "
        SELECT k.ID_KIT, k.NOMBRE, k.DESCRIPCION, k.PRECIO, i.URL
        FROM kits k
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          $productosHTML .= "
            <div class=\"cell-sm-6 cell-md-4\">
              ...
              <button class=\"btn-comprar\" onclick=\"redirectToForm('{$nombre}', '{$descripcion}', '{$subtitulo}')\">Comprar</button>
            </div>
          ";
...
<script>
  function redirectToForm(nombre, descripcion, precio) {
  ...
  window.location.href = `habitaciones/confirmar_reserva.php?nombre=${nombreEncoded}&descripcion=${descripcionEncoded}&precio=${precioEncoded}`;
}
