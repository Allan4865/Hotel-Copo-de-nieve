        ...
        <div class="container">
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        <!-- Sección de opciones de navegación -->
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="ver_reserva.php?type=pago">Visualizar</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="visualizar_cliente.php?type=clientes">Visualizar</a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-danger" href="?logout=true">Cerrar sesión</a>
                        </li>
                    </ul>
                </div>
            </div>
