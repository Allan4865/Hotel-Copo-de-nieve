...
<body>
    ...
    <form id="habitacionForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <select id="tipo" name="tipo" required>
            ...
            <option value="cuadruples">Cuádruples</option>
    ...
    if (!isset($_SESSION['username'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO habitaciones (TIPO, DESCRIPCION, PRECIOPORNOCHE, CAPACIDAD, CAMAS, BANO) 
                    VALUES ('$tipo', '$descripcion', '$precio_por_noche', '$capacidad', '$camas', '$bano')";
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                $id_habitacion = $conn->insert_id;
        
                // Insertar la imagen en la tabla imagenes_habitaciones
